...
def dashboard():
    os.system(r'streamlit run C:\Users\HP\Desktop\Main\Thapar\Capstone_Project\Drone_Based_Surveillance_System\DashBoard\DashBoard\Dashboard_mian.py')
...
if login_button:
    ...
    if username == '102003133' and password == 'Admin@123':
        ...
        is_logged_in = True
        #os.system(r'cd  C:\Users\ishit\Desktop\DashBoard')
        # st.write(os.listdir(r'C:\Users\ishit\Desktop\DashBoard'))
        t1 = threading.Thread(target=exit)
        t1.start()
        t0 = threading.Thread(target=dashboard)
        t0.start()
